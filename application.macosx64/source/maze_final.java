...
public class maze_final extends PApplet {
 ...
 */
public void check(PVector to, PVector frm)
{
...
public class HeuristicDistance implements Comparator<PVector>
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#000000", "--hide-stop", "maze_final" };
    if (passedArgs != null) {
